...
<div class="grid grid-rows-2 grid-cols-1 align-content-center"
     style="opacity: 0.5; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);">
    <img src="./easl-logo.svg" width="800" />
    <div class="grid grid-cols-1">
        <div class="mt-16 mb-16 text-5xl text-bold text-center overview-animation opacity-75">Welcome to EASL</div>
        <div class="grid grid-cols-2 align-content-center">
            ...
            hover:bg-indigo-500 hover:text-indigo-100" onclick="window.location.href='{{ url('register') }}';">Signup</button>
        </div>
    </div>

    <div class="grid grid-rows-2 text-4xl text-center text-gray-400" style="padding-top: 100px;">
        <p>Learn More . . .</p>
        <i class="fa fa-solid fa-arrow-down text-gray-500 text-5xl"></i>
    </div>
