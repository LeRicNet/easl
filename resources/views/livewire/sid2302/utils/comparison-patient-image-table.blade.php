<div class="bg-white border-2 border-slate-500 shadow rounded h-[11rem] overflow-y-auto" wire:poll.1ms>
            ...
            "hidden" => ! (($selected == $study['study_uid']) and ($show_barco_options))
                ...
                <div class="flex py-1 ">
                    <div class="basis-1/2 text-end pe-2">
                        <button id="update_barco_comparison_left"
                    ...
                    <div class="basis-1/2 text-start ps-2">
                        <button id="update_barco_comparison_right"
