...
<div style="height: 100%; width: 100%; position: relative;">
    ...
    @if(empty($working_project_id))
        <div
            style="margin-top: 50px; text-align: center;"
            class="text-xl text-gray-600">
            No Project Loaded
            <div class="text-sm">
                (projects can be started or imported from the menu in the top-right)
            </div>
            <div class="pt-5 text-sm">
                Information about <a href="#" class="link-default">Projects</a> can be found in the EASL Handbook.
            </div>
        </div>
    @else
    ...
    <div>
        ...
        <div class="pl-2 text-gray-400 text-sm">
            Created: {{ $project_created_at }}, Last Updated: {{ $project_updated_at }}
        </div>
        ...
        <div class="pl-2">
            <textarea id="project-abstract"
                      wire:model="working_project_abstract"
        ...
        <div class="pl-2 text-gray-600">
            Surveys: <button type="submit">Add Survey</button>
        </div>
            ...
            @foreach($project_library as $project)
                <tr class="hover:bg-gray-300">
                    ...
                    <td style="text-align: center;">
                        ...
                        <button
                            type="submit" wire:click="attach('{{ $project->id }}')">
...
{{-- Script for dropdown & modal functionality --}}
<script>
