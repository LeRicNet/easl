...
<div class="tabs">
    <ul class="tabs__navbar flex flex-wrap border-b border-gray-200">
        ...
        <li class="mr-1">
            <button class="tabs__button inline-block bg-gray-100 border-2 border-gray-200 text-blue-600--}}
            rounded-t-lg py-2 px-3 text-sm font-medium text-center" data-for-tab="4">Help</button>
        </li>
    </ul>
    ...
    <div class="tabs__content hidden" data-tab="3">
        <div class="grid grid-flow-row grid-flow-col ml-2 mt-2 mr-2 mb-2 h-screen">
            <iframe class="shadow shadow-black w-full h-full" src="orthanc"></iframe>
        </div>
    </div>
