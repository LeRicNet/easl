            ...
            text-gray-900 sm:text-1xl sm:leading-none md:text-1xl pb-5">Add New Sample</h1>
                    ...
                    <div class="flex justify-left">
                        <div class="mb-3 xl:w-96">
                            <label for="exampleText0"
                                   class="form-label inline-block mb-2 text-gray-700">Primary Identification Number (PIN)</label>
                            <input
                ...
                <div class="grid grid-cols-2 grid-flow-row">
                    ...
                    <div class="grid grid-cols-1 grid-flow-row">
                        ...
                        <textarea id="sample_description" class="border border-solid border-gray-300 rounded-lg"></textarea>
                    </div>
            ...
            <!-- END DICOM Upload -->
                ...
                <div class="flex flex-row justify-end bg-gray-50 px-4 py-5 sm:px-6 sm:flex sm:flex-row">
                    ...
                    <div wire:click="saveSample"
                     ...
                     active:bg-indigo-700 cursor-pointer">Submit
                    </div>
